...
const Dashboard = () => {
  ...
  return (
    <div className="container">
      ...
      <p>
        Добро пожаловать в репозиторий для интервью на позицию "Senior Frontend
        Разработчик". Рекомендуется выполнять задания в указанном порядке, но вы
        можете переключаться между ними. Также, не забудьте ознакомиться с
        советами. Удачи!
      </p>
